...
def export2somaworkflow(in_datasets_file_relative_path,
    ...
    in_nodes: a list of epac.base.WFNode
        All the data (e.g. in_datasets_file_relative_path) should use
        relative paths, and "in_working_directory" contains those data.
        The nodes can be generated by
        e.g. 'nodes = wf.get_node(regexp="*/Perms/*")' Once
