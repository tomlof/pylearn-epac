# -*- coding: utf-8 -*-
#
# epac documentation build configuration file, created by
...
extensions = ['sphinxtogithub', 'sphinx.ext.todo', 'sphinx.ext.viewcode', 'sphinx.ext.autodoc', 'sphinx.ext.autosummary']
